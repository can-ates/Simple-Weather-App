    ...
    return (
      <div className='components-wrapper' style={{backgroundImage: isEvening ? `url(${evening})` : `url(${morning})`}}>
        {this.state.isSubmitted ? (
          <div className='datas'>
            <CurrentWeather className='components' city={this.state.datas} />
            <DailyForecast className='components' coord={this.state.datas.coord}/>
          </div>
        ) : (
          isEvening ? <div className='welcome'>
              <Typograpyh className='welcome-text' variant='h1'>Much Weather!</Typograpyh>
              <Typograpyh className='welcome-text' variant='h2'>Good Evening</Typograpyh>
                      </div> 
                     :   
                      <div className='welcome'>
              <Typograpyh className='welcome-text' variant='h1'>Much Weather!</Typograpyh>
              <Typograpyh variant='h2' className='welcome-text'>Have a great day</Typograpyh>
                      </div>
        )}
